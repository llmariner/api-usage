...
func (*GetUsageDataRequest_Filter) Descriptor() ([]byte, []int) {
	return file_api_v1_usage_server_proto_rawDescGZIP(), []int{3, 0}
}
...
var file_api_v1_usage_server_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x69, 0x2f, 0x68, 0x74, 0x74, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x74,
	...
	0x65, 0x73, 0x32, 0x95, 0x03, 0x0a, 0x0f, 0x41, 0x50, 0x49, 0x55, 0x73, 0x61, 0x67, 0x65, 0x53,
	...
	0x61, 0x70, 0x69, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x73, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x6c, 0x6d, 0x61, 0x72, 0x69, 0x6e,
	0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x75, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x61, 0x70, 0x69,
...
var file_api_v1_usage_server_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_api_v1_usage_server_proto_goTypes = []interface{}{
	...
	(*GetUsageDataRequest)(nil),         // 3: llmariner.apiusage.server.v1.GetUsageDataRequest
	(*UsageData)(nil),                   // 4: llmariner.apiusage.server.v1.UsageData
	(*UsageDataPoint)(nil),              // 5: llmariner.apiusage.server.v1.UsageDataPoint
	(*ListUsageDataRequest)(nil),        // 6: llmariner.apiusage.server.v1.ListUsageDataRequest
	(*UsageDataByGroup)(nil),            // 7: llmariner.apiusage.server.v1.UsageDataByGroup
	(*ListUsageDataResponse)(nil),       // 8: llmariner.apiusage.server.v1.ListUsageDataResponse
	(*GetUsageDataRequest_Filter)(nil),  // 9: llmariner.apiusage.server.v1.GetUsageDataRequest.Filter
}
var file_api_v1_usage_server_proto_depIdxs = []int32{
	...
	9, // 2: llmariner.apiusage.server.v1.GetUsageDataRequest.filter:type_name -> llmariner.apiusage.server.v1.GetUsageDataRequest.Filter
	5, // 3: llmariner.apiusage.server.v1.UsageData.data_points:type_name -> llmariner.apiusage.server.v1.UsageDataPoint
	7, // 4: llmariner.apiusage.server.v1.ListUsageDataResponse.usages:type_name -> llmariner.apiusage.server.v1.UsageDataByGroup
	0, // 5: llmariner.apiusage.server.v1.APIUsageService.GetAggregatedSummary:input_type -> llmariner.apiusage.server.v1.GetAggregatedSummaryRequest
	3, // 6: llmariner.apiusage.server.v1.APIUsageService.GetUsageData:input_type -> llmariner.apiusage.server.v1.GetUsageDataRequest
	6, // 7: llmariner.apiusage.server.v1.APIUsageService.ListUsageData:input_type -> llmariner.apiusage.server.v1.ListUsageDataRequest
	2, // 8: llmariner.apiusage.server.v1.APIUsageService.GetAggregatedSummary:output_type -> llmariner.apiusage.server.v1.AggregatedSummary
	4, // 9: llmariner.apiusage.server.v1.APIUsageService.GetUsageData:output_type -> llmariner.apiusage.server.v1.UsageData
	8, // 10: llmariner.apiusage.server.v1.APIUsageService.ListUsageData:output_type -> llmariner.apiusage.server.v1.ListUsageDataResponse
